...
<form method="post" action="">
    <div class="row mb-3">
        <div class="col">
            <div class="form-group">
                ...
                <input id="firstname" type="text" name="firstname" value="<?= e($request->old('firstname')); ?>"
                       class="form-control <?= $request->hasError('firstname') ? 'is-invalid' : '' ?>">
                <div class="invalid-feedback">
                    <?= e($request->getFirstError('firstname')); ?>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="form-group">
                ...
                <input id="lastname" type="text" name="lastname" value="<?= e($request->old('lastname')); ?>"
                       class="form-control <?= $request->hasError('lastname') ? 'is-invalid' : '' ?>">
                <div class="invalid-feedback">
                    <?= e($request->getFirstError('lastname')); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group mb-3">
        ...
        <input id="confirm-password" type="password" name="confirmPassword" value="<?= e($request->old('confirmPassword')); ?>"
               class="form-control <?= $request->hasError('confirmPassword') ? 'is-invalid' : '' ?>">
        <div class="invalid-feedback">
            <?= e($request->getFirstError('confirmPassword')); ?>
        </div>
    </div>
